...
function generarTabla(datos) {
    ...
    for (let valor of JSON.parse(datos)) {
        ...
        <tr>
                        ...
                        <td><button  idRol="${cont}" style="color: dimgrey;" onclick="location.href='/Seguridad/EditarRol'">Editar Estado</button>
                        </td> 
...
$("#contenido").on('click', 'button', function () {
    ...
    localStorage.setItem('idRoles', idRol);//Indice seleccionado que se va a editar
    localStorage.setItem('usuariosRol', JSON.stringify(ArrUsuarios));//ese guarda el arreglo de consecutivos para poder usarlo en otro JS.
