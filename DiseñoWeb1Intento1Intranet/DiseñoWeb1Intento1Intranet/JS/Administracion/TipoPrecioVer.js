...
function generarTabla(datos) {
    ...
    for (let valor of JSON.parse(datos)) {
        ...
        <tr>
                        ...
                        <td><a  id="${cont}" style="color: dimgrey;" href='/Administracion/EdicionNuevoEliminarTipoPrecio '>Editar</a></td>   
...
$("#contenido").on('click', 'a', function () {
    ...
    localStorage.setItem('idTP', id);//Indice seleccionado que se va a editar
    localStorage.setItem('tipoPrecio', JSON.stringify(ArrTipoPrecio));//ese guarda el arreglo de consecutivos para poder usarlo en otro JS.
