...
function generarTabla(datos) {
    ...
    for (let valor of JSON.parse(datos)) {
        ...
        <tr>
                        ...
                        <td><a  id="${cont}" style="color: dimgrey;" href='/Administracion/EdicionTiqueteDescuento '>Editar</a></td>   
...
$("#contenido").on('click', 'a', function () {
    ...
    localStorage.setItem('idTiquete', id);//Indice seleccionado que se va a editar
    localStorage.setItem('tiqueteDescuento', JSON.stringify(ArrTiquetDescuento));//ese guarda el arreglo de consecutivos para poder usarlo en otro JS.
...
$("#contenido").on('click', 'button', function () {
    var id = $(this).attr('id');
    var confirmacion = confirm('¿Seguro que desea eliminar el tiquete de descuento?');
...
function eliminar(id) {
    ...
    var url = 'https://localhost:44308/api/TiqueteDescuento/1';
    console.log(url);
